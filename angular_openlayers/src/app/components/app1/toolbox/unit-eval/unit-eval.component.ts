...
@Component({
    selector: 'app-unit-eval',
    imports: [MatButtonModule, MatIconModule, MatTooltipModule],
    templateUrl: './unit-eval.component.html',
    styleUrls: ['./unit-eval.component.scss', '../toolbox.component.scss']
})
export class UnitEvalComponent implements OnInit {
  isActive = false;
